...
// Replaces: World2D.vert + Point2D.geom + Point.frag
// Used by: Point2D
//
// Strategy: Each point is an instance providing one 2D position. The vertex shader
// generates a quad (6 vertices) around the point in screen space. The fragment shader
// applies a smooth circular falloff.
