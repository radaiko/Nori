// ────── ╔╗                                                                            DEMOS.LINUX
// ╔═╦╦═╦╦╬╣ Program.cs
// ║║║║╬║╔╣║ Entry point for the Linux SDL2 demo application hosting cross-platform scenes
// ╚╩═╩═╩╝╚╝ ───────────────────────────────────────────────────────────────────────────────────────
using Nori;
...
ISurface surface = platform.CreateSurface ("Nori Demos \u2014 Linux", 1280, 800);
...
Console.WriteLine ("Nori Demos \u2014 Linux (SDL2 + WebGPU)");
