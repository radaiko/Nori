// ────── ╔╗                                                                                  DEMOS
// ╔═╦╦═╦╦╬╣ T3XDemo.cs
// ║║║║╬║╔╣║ Demo for loading and displaying T3X format files
// ╚╩═╩═╩╝╚╝ ───────────────────────────────────────────────────────────────────────────────────────
using System.Collections.Immutable;
namespace Nori;

#region class T3XDemoScene -------------------------------------------------------------------------
class T3XDemoScene : Scene3 {
   public T3XDemoScene () {
      Model3 blank = new T3XReader ($"{Lib.DevRoot}/Demos/Data/5x-043-blank.t3x").Load ();
      Model3 part = mModel = new T3XReader ($"{Lib.DevRoot}/Demos/Data/5x-043.t3x").Load ();
...
#region class NormalVN -----------------------------------------------------------------------------
class NormalVN : VNode {
   public NormalVN () { }

   /// <summary>The surface whose normals are drawn</summary>
   ...
   public override void Draw () {
      if (Surface != null) {
         ...
         ImmutableArray<Mesh3.Node> nodes = mesh.Vertex; ImmutableArray<int> tris = mesh.Triangle;
