// ────── ╔╗                                                                                  DEMOS
// ╔═╦╦═╦╦╬╣ BuildOBBDemo.cs
// ║║║║╬║╔╣║ Demonstrates oriented bounding box (OBB) construction algorithms
// ╚╩═╩═╩╝╚╝ ───────────────────────────────────────────────────────────────────────────────────────
namespace Nori;

#region class BuildOBBScene ------------------------------------------------------------------------
class BuildOBBScene : Scene3 {
   ...
   public override void Picked (object obj) {
      ...
      using (BlockTimer bt = new ("OBB.Build"))
         mOBB.OBB = OBB.Build (pts.AsSpan ());
      using (BlockTimer bt = new ("OBB.BuildFast"))
