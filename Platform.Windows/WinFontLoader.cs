// ────── ╔╗                                                                       PLATFORM.WINDOWS
// ╔═╦╦═╦╦╬╣ WinFontLoader.cs
// ║║║║╬║╔╣║ Windows font loader using FreeType P/Invoke for loading font faces
// ╚╩═╩═╩╝╚╝ ───────────────────────────────────────────────────────────────────────────────────────
using System.Reflection;
using System.Runtime.InteropServices;
namespace Nori;

#region class WinFontLoader ------------------------------------------------------------------------
/// <summary>Windows IFontLoader implementation delegating to FreeType native library</summary>
class WinFontLoader : IFontLoader {
   // Methods ------------------------------------------------------------------
   ...
   static WinFontLoader () {
      NativeLibrary.SetDllImportResolver (typeof (WinFontLoader).Assembly, ResolveLibrary);
   }
